...
<div id="main" class="main">
	...
	<aside id="sidebar" class="sidebar">
		<div id="html-tags-list">
			...
			<input class="search" placeholder="Search jQuery Properties" />
			<ul class="list">
				<?php 
				$args = array(
					'orderby'			=> 'date',
					'order'				=> 'ASC',
					'post_type'			=> 'jquery-property',
					'post_status'		=> 'publish',
					'posts_per_page'	=> -1
				);
		...
		<div id="main_content" class="main_content" >
				...
				if ( $the_query->have_posts() ) {
					while ( $the_query->have_posts() ) {
						...
						echo '<h1 class="feature-block-title">jQuery '.the_slug().' Property</h1>';
						...
						echo '<h1 class="feature-box-title">Live Example for jQuery '.the_slug().' Property</h1>';
						echo '<div class="feature-box-content">';
						
						global $switched;
						switch_to_blog(1);
						$bit_title = 'jquery-'.strtolower(the_slug()).'-property';
			...
			<div class="info-about">
                    <h3 class="ciu-section-heading1">What is jQuery ?</h3>
