...
<div id="screen-meta-links">
    ...
    <div id="screen-options-link-wrap" class="hide-if-no-js screen-meta-toggle">
	    ...
	    <!--<div id="screen-options-link-wrap" class="hide-if-no-js screen-meta-toggle">
        <button type="button" class="clearLink button"  title="Click to clear all"> Reset </button>
    </div>-->
</div>
...
<div id="wpfooter" role="contentinfo">
    <p id="footer-left" class="alignleft">
        <span id="footer-thankyou">By <a href="http://darlic.com/">Darlic</a><sup>TM</sup>. Darlic is a registered trademark of <a href="http://oxosolutions.com/">OXOSolutions</a>.</span>
    </p>
