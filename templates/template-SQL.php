...
<div id="main" class="main">
	...
	<aside id="sidebar" class="sidebar">
		<div id="html-tags-list">
			...
			<input class="search" placeholder="Search SQL Fundamentals" />
			<ul class="list">
				<?php 
				$args = array(
					'orderby'			=> 'date',
					'order'				=> 'ASC',
					'post_type'			=> 'sql-fundamental',
					'post_status'		=> 'publish',
					'posts_per_page'	=> -1
				);
		...
		<div id="main_content" class="main_content" >
				...
				if ( $the_query->have_posts() ) {
					while ( $the_query->have_posts() ) {
						...
						echo '<h1 class="feature-block-title">SQL '.the_slug().' </h1>';
						...
						echo '<h1 class="feature-box-title">Live Example for SQL '.the_slug().'</h1>';
			...
			<div class="info-about">
                    <h3 class="ciu-section-heading1">What is SQL?</h3>
