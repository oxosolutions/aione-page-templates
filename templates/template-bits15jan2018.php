	...
	jQuery( document ).ready(function(){
		...
		function changeLikeDislike(type,id,value){
	      ...
	      var bitsStorageJson = JSON.parse(localStorage.getItem("bitsStorage") || "[]");
 		  console.log(bitsStorageJson);
	      //var already = jQuery( "#"+postID+"_"+type+" span:first-child" ).hasClass( type+"-icon" );
	      ...
	      if(!already){
	      	...
	      	//var already = jQuery( "#"+postID+"_"+type+" span:first-child" ).addClass( type+"-icon" );
